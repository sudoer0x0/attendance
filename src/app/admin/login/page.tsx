    ...
    <div className="flex min-h-dvh items-center justify-center bg-[var(--color-surface-subtle)] px-4">
      <div className="w-full max-w-[380px]">
        <div className="mb-8 text-center">
          <Badge>Departmental Portal</Badge>
          ...
          <p className="mt-1 text-[13.5px] text-[var(--color-ink-subtle)]">
            {stage === "credentials" ? "Sign in to manage your department roster" : "Enter your authenticator code"}
          </p>
        </div>
          ...
          {stage === "credentials" ? (
            ...
            <div className="flex flex-col gap-4">
              <Input
                ...
                hint="From your authenticator app. Lost access? Contact the Super Admin."
              />
            </div>
          )}
